...
// Auth pages
import { ClerkRedirectPage } from '@/pages/auth/clerk-redirect';
  ...
  return (
    <div className="min-h-[100dvh] flex flex-col bg-background">
      <Routes>
        ...
        {/* Auth Routes */}
        <Route path="/auth">
          <Route path="clerk-redirect" element={<ClerkRedirectPage />} />
          {/* Redirect old auth routes to home (since we're using Clerk modal UI now) */}
