    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 pt-20">
        <main className="flex min-h-screen flex-col items-center justify-center p-24">
          <h1 className="text-4xl font-bold mb-8">Welcome to Bliss</h1>
          <p className="text-xl mb-8">Your gateway to spiritual wisdom and knowledge</p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl">
            <a href="/books" className="p-6 border rounded-lg hover:bg-gray-50 transition-colors">
              <h2 className="text-2xl font-semibold mb-2">Books</h2>
              <p className="text-gray-600">Explore our collection of spiritual books and texts</p>
            </a>

            <a href="/places" className="p-6 border rounded-lg hover:bg-gray-50 transition-colors">
              <h2 className="text-2xl font-semibold mb-2">Places</h2>
              <p className="text-gray-600">Discover sacred and spiritual locations</p>
            </a>

            <a href="/teachings" className="p-6 border rounded-lg hover:bg-gray-50 transition-colors">
              <h2 className="text-2xl font-semibold mb-2">Teachings</h2>
              <p className="text-gray-600">Learn from spiritual teachings and wisdom</p>
            </a>
          </div>
        </main>
      </main>
      ...
      <h1 className="text-3xl font-bold mb-6">Welcome to Bliss</h1>
      <p className="text-lg text-gray-700 mb-4">Your gateway to spiritual wisdom and knowledge.</p>

      {/* Content sections would go here */}
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 mt-8">
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-3">Sacred Texts</h2>
          <p className="text-gray-600">
            Explore ancient wisdom through our collection of sacred texts and commentaries.
          </p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-3">Spiritual Teachings</h2>
          <p className="text-gray-600">Discover insights from spiritual masters across traditions and time periods.</p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-3">Sacred Places</h2>
          <p className="text-gray-600">
            Learn about temples, pilgrimage sites, and other sacred locations around the world.
          </p>
        </div>
      </div>
    </div>
